...
const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <div ref={ref} className={cn("group relative fade-in-element", { 'is-visible': inView }, project.large ? 'lg:col-span-2' : '')}>
      <div className="glass h-full p-8 rounded-2xl flex flex-col group-hover:translate-y-[-8px] group-hover:scale-103 group-hover:shadow-2xl group-hover:shadow-primary/20 relative overflow-hidden transition-transform duration-300 ease-in-out will-change-transform">
        ...
        {/* This div displays the icon passed from the projects array */}
...
const projects = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 gradient-text mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      link: 'https://employee-mm.vercel.app'
    },
    {
      id: 3,
      title: 'MiYanMar AI',
